...
export const MEDICATION_PROTOCOLS = {
  labetalol: {
    ...
    route: 'IV' as const,
    doses: [
      { step: 1, medication: 'Labetalol', dose: '20mg', route: 'IV' as const, waitTime: 0.17 },
      { step: 2, medication: 'Labetalol', dose: '40mg', route: 'IV' as const, waitTime: 0.17 },
      { step: 3, medication: 'Labetalol', dose: '80mg', route: 'IV' as const, waitTime: 0.17 },
    ],
  ...
  hydralazine: {
    ...
    route: 'IV' as const,
    doses: [
      { step: 1, medication: 'Hydralazine', dose: '5-10mg', route: 'IV' as const, waitTime: 0.17 },
      { step: 2, medication: 'Hydralazine', dose: '10mg', route: 'IV' as const, waitTime: 0.17 },
    ],
    contraindications: [],
    maxDoses: 2,
  },
  nifedipine: {
    ...
    route: 'PO' as const,
    doses: [
      { step: 1, medication: 'Nifedipine', dose: '10mg', route: 'PO' as const, waitTime: 0.17 },
      { step: 2, medication: 'Nifedipine', dose: '20mg', route: 'PO' as const, waitTime: 0.17 },
      { step: 3, medication: 'Nifedipine', dose: '20mg', route: 'PO' as const, waitTime: 0.17 },
    ],
    contraindications: [],
    maxDoses: 3,
  },
